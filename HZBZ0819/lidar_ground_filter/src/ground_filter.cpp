                                 ...
                                 pcl::PointCloud<pcl::PointXYZI>::Ptr not_ground_pc)
{
    ...
    int column = 80 / grid_size_c + 2;
    int row = 60 / grid_size_r + 2;
    GroundFilter grid[column][row];
    for (int i = 0; i < cloud->points.size(); i++)
    {
        int m = floor(cloud->points[i].x / grid_size_r) + row / 2;
        ...
        for (int j = 1; j < row - 1; j++)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (grid[i][j].cloud->points[k].z - grid[i][j].h_min < grid_hdifference_th_r)
                        {
